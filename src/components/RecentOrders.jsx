				...
				<>
					...
					<div className="mt-3">
						...
						<Pagination
							...
							offset={1}
							classNames={{
								wrapper: 'flex m-auto justify-center  select-none',
								item: 'p-1 w-7 flex justify-center items-center border-2 m-1 text-sm hover:cursor-pointer hover:bg-blue-400 rounded-md',
								itemActive: 'pagination-item-active',
								navPrev:
									'p-1 w-7 flex justify-center items-center border-2 m-1 text-sm hover:cursor-pointer hover:bg-blue-400 rounded-md',
								navNext:
									'p-1 w-7 flex justify-center items-center border-2 m-1 text-sm hover:cursor-pointer hover:bg-blue-400 rounded-md',
								navStart:
